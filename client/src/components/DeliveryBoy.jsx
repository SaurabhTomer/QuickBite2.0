...
function DeliveryBoy() {
  ...
  //chnage delivery boy loaction using socket io
  useEffect(() => {
  ...
  //calculate total of delivery boy money
  ...
  //hget current order controller fetch
